      ...
      dikabot.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: "𝐁𝐲 𝐃𝐢𝐤𝐚 𝐈𝐃",
            previewType: "PHOTO",
            thumbnailUrl: "https://img102.pixhost.to/images/148/557606218_skyzopedia.jpg",
    ...
    const v192 = {
      ...
      message: {
        contactMessage: {
          ...
          jpegThumbnail: {
            url: "https://img102.pixhost.to/images/148/557606218_skyzopedia.jpg"
          }
        }
      }
    };
      ...
      case "menu":
        {
          vF6(`
「 𝐁𝐑𝐔𝐓𝐀𝐋𝐈𝐓𝐘 𝟐𝟎𝟐𝟓 」
Hi 👋 ${m.pushName} saya adalah bot whatsapp *Brutality* yang dirancang untuk membantu anda!
...
〤 *〈 𝗔𝗸𝘀𝗲𝘀 𝗕𝗼𝘁 〉* 〤
➙ ${v18} addowner _*628xxx/@tag*_
➙ ${v18} addprem _*628xxx/@tag*_
➙ ${v18} delowner _*628xxx/@tag*_
➙ ${v18} delprem _*628xxx/@tag*_
➙ ${v18} public/self

〤 *〈 𝗖𝗿𝗲𝗱𝗶𝘁 𝗦𝗰𝗿𝗶𝗽𝘁 〉* 〤
𝘚𝘤𝘳𝘪𝘱𝘵 𝘪𝘯𝘪 𝘥𝘪𝘣𝘶𝘢𝘵 𝘰𝘭𝘦𝘩 𝘋𝘪𝘬𝘢 𝘐𝘋, 𝘪𝘯𝘨𝘪𝘯 𝘮𝘦𝘮𝘣𝘦𝘭𝘪 𝘴𝘤𝘳𝘪𝘱𝘵?
𝘛𝘦𝘭𝘦𝘨𝘳𝘢𝘮 : @𝘥𝘪𝘬𝘢𝘪𝘥_𝘵𝘦𝘤𝘩`);
        }
        break;
      case "bugmenu":
        {
...
〤 *〈 𝗕𝘂𝗴 𝗠𝗲𝗻𝘂 〉* 〤
➙ ${v18} dikabug _*628xxx*_
➙ ${v18} brutality _*628xxx*_
➙ ${v18} trash-fc _*628xxx*_
➙ ${v18} xlokas _*628xxx*_
➙ ${v18} dokufc _*628xxx*_
➙ ${v18} 💥 _*628xxx*_
➙ ${v18} 🗯️ _*628xxx*_
➙ ${v18} 💦 _*628xxx*_
...
➙ ${v18} hidetag
➙ ${v18} tagall
➙ ${v18} kick _*628xxx/@tag*_
➙ ${v18} promote _*628xxx/@tag*_
➙ " + v18 + "demote _*628xxx/@tag*_
...
𝘛𝘦𝘭𝘦𝘨𝘳𝘢𝘮 : @𝘥𝘪𝘬𝘢𝘪𝘥_𝘵𝘦𝘤𝘩`);
      ...
      case "bandperma-batu":
        {
          vF6(`
𝗣𝗶𝗻𝗴𝗶𝗻 𝗕𝗮𝗻𝗻𝗲𝗱? 𝗠𝗮𝘀𝘂𝗸 𝗦𝗶𝗻𝗶 𝗗𝘂𝗹𝘂
https://whatsapp.com/channel/0029Vb2p1HE30LKPHy1Psq3V
          
𝗦𝗲𝘁𝗲𝗹𝗮𝗵 𝗠𝗮𝘀𝘂𝗸 𝗞𝗮𝗺𝘂 𝗕𝗶𝘀𝗮 𝗕𝗮𝗻𝗻𝗲𝗱
𝗰𝗼𝗻𝘁𝗼𝗵 : banned-spam +𝟲𝟮𝘅𝘅𝘅`);
        }
        break;
      case "sc":
        {
          vF6(`sc
𝗖𝗮𝗿𝗶 𝗦𝗰 𝗚𝗮𝗰𝗼𝗿 𝗠𝗮𝘀𝘂𝗸 𝗦𝗶𝗻𝗶
https://whatsapp.com/channel/0029Vb30zLXLo4hWVPChF41q
          
𝗥𝗶𝘃𝗲𝘄 𝗦𝗰 𝗚𝗮𝗰𝗼𝗿 𝗪𝗮𝗷𝗶𝗯 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲
https://www.youtube.com/@AndraZyy`);
        }
        break;
      case "paptt":
        if (!q) {
          return vF6("`[ # ] 𝘿𝙄𝙆𝘼 𝙄𝘿` \n*𝘊𝘰𝘯𝘵𝘰𝘩 " + (v18 + v20) + " 𝘧𝘰𝘵𝘰/𝘷𝘪𝘥𝘦𝘰*");
        }
